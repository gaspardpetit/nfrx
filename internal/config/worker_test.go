...
func TestResolveWorkerPaths(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			goos:       "linux",
			home:       "/home/user",
			wantConfig: "/etc/infx/worker.yaml",
			wantLogDir: "",
		},
		{
			name:       "darwin",
			goos:       "darwin",
			home:       "/Users/test",
			wantConfig: "/Users/test/Library/Application Support/infx/worker.yaml",
			wantLogDir: "/Users/test/Library/Logs/infx",
		},
		{
			name:        "windows",
			goos:        "windows",
			programData: "C:\\ProgramData",
			wantConfig:  "C:/ProgramData/infx/worker.yaml",
			wantLogDir:  "C:/ProgramData/infx/Logs",
		},
		{
