...
func TestResolveWorkerPaths(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			goos:       "linux",
			home:       "/home/user",
			wantConfig: "/etc/infero/worker.yaml",
			wantLogDir: "",
		},
		{
			name:       "darwin",
			goos:       "darwin",
			home:       "/Users/test",
			wantConfig: "/Users/test/Library/Application Support/infero/worker.yaml",
			wantLogDir: "/Users/test/Library/Logs/infero",
		},
		{
			name:        "windows",
			goos:        "windows",
			programData: "C:\\ProgramData",
			wantConfig:  "C:/ProgramData/infero/worker.yaml",
			wantLogDir:  "C:/ProgramData/infero/Logs",
		},
		{
